-- ==========================================
-- DATA STRUCTURE LAB PROJECT (MariaDB / MySQL)
-- Database: data_structure_lab
-- Rules:
...
DROP DATABASE IF EXISTS data_structure_lab;
CREATE DATABASE data_structure_lab
  CHARACTER SET utf8mb4
  COLLATE utf8mb4_general_ci;
USE data_structure_lab;
...
CREATE TABLE parking_lot (
  ...
  opening_hours  VARCHAR(11)   NOT NULL DEFAULT '08:00-23:59',
...
CREATE TABLE camera (
  ...
  CONSTRAINT fk_camera_lot FOREIGN KEY (lot_id) REFERENCES parking_lot(lot_id)
    ON UPDATE CASCADE
    ON DELETE RESTRICT,
  CONSTRAINT uq_camera_lot UNIQUE (lot_id)
) ENGINE=InnoDB;
...
--   password: 1234   (BCrypt hash below)
INSERT INTO driver (driver_id, full_name, email, phone_number, password_hash) VALUES
(1, 'Mahmoud', 'mahmoud@gmail.com', '96170123456',
 '$2b$10$V/.4snYAu/JAb1MpiGVkaO5.CO1hxxYjkbZLmGBLsMeS5UEua72RK');
